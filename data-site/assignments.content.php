...
$addAssignment = "<p><a href=\"assignment-add.php\" class=\"icon-button\"><i class=\"fas fa-plus-circle\"></i> Add assignment</a></p>";

echo $tableStart . $tableData . $tableEnd . $addAssignment;
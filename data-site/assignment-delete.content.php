...
if (isset($_POST['id'])) {
	...
	$success .= "<p>{$postname} {$postdescription} {$postcourse_id} ({$postdeadline})</p>\n";
...
$assignmentData .= "<p>Are you sure you want to delete {$data->name} {$data->description} {$data->course_id} ({$data->deadline})?</p>\n";
